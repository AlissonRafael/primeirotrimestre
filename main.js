...
function atualizaCronometro(){
    ...
    document.getElementById("horas0").textContent = calculaTempo(temos[1])[1];
    document.getElementById("min0").textContent = calculaTempo(temos[1])[2];
    document.getElementById("seg0").textContent = calculaTempo(temos[1])[3];
